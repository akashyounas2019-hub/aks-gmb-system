      ...
      <div className="w-full max-w-md rounded-2xl border border-border bg-card p-8 shadow-xl">
        ...
        >
          <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden>
            ...
            <path
              fill="#FF3D00"
              d="M6.3 14.7l6.6 4.8C14.7 15.6 19 12.5 24 12.5c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34 6.1 29.3 4 24 4 16.3 4 9.7 8.3 6.3 14.7z"
            />
            <path
              fill="#4CAF50"
              d="M24 44c5.2 0 9.9-2 13.4-5.2l-6.2-5.2c-2 1.4-4.5 2.3-7.2 2.3-5.3 0-9.7-3.3-11.3-8l-6.5 5C9.5 39.6 16.2 44 24 44z"
            />
            <path
              fill="#1976D2"
              d="M43.6 20.5H42V20H24v8h11.3c-.7 2.1-2 4-3.8 5.4l6.2 5.2c-.4.4 6.3-4.6 6.3-14.6 0-1.3-.1-2.4-.4-3.5z"
            />
          </svg>
